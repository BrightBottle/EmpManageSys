					...
					<div class="row">
						<section class="col col-4">
							<label class="label">工号</label> <label class="input"> 
							      <input name="empId" value="${userModel.empId }" data-rule="required" type="text" maxlength="50">
							</label>
						</section>
						<section class="col col-4">
							<label class="label">年龄</label> <label class="input"> 
							      <input name="age" value="${userModel.age }" data-rule="required" type="text" maxlength="50">
							</label>
						</section>
						<section class="col col-4">
						...
						<section class="col col-4">
							<label class="label">毕业院校</label> <label class="input"> 
							     <input type="text" value="${userModel.school }" data-rule="required" name="school" maxlength="20">
							</label>
						</section>
						</div>
						<div class="row">
						<section class="col col-4">
							<label class="label">学历</label> <label class="input"> 
							     <input type="text" value="${userModel.degree }" data-rule="required" name="degree" maxlength="20">
							</label>
						</section>
						<section class="col col-4">
