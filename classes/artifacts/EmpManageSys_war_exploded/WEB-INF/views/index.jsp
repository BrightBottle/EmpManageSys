...
<body class="index-body fixed-header fixed-ribbon fixed-navigation">
	...
	<header id="header">
		<!-- 标题和logo -->
		<div id="logo-group">
			<span id="logo"> EmpManageSys </span>
		</div>
	...
	<aside id="left-panel">
		<nav>
			<ul>
				<!-- 首页 -->
				<li class="dashboard">
					<a href="dashboard/" title="Dashboard"> <i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">功能菜单</span>
					</a>
				</li>
